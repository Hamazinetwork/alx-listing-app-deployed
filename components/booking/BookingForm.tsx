const BookingForm = () =>(
    <div className="bg-white p-6 shadow-md rounded-lg">
        ...
        <form>
            ...
            {/* Billing Address */}
            <h2 className="tetx-xl font-semibold mt-6">Billing Address </h2>
            <div className="mt-4">
                <label>Street Address</label>
                <input type="text" className="border w-full mt-2"/>
            </div>
            <div className="grid grid-col-2 mt-4 gap-6">
                <div>
                    <label>City</label>
                ...
                <div> 
                    <label>State</label>
                    <input type="text" className="border w-full mt-2 p-2"/>
                </div>
                <div> 
