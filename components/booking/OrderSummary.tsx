    ...
    <div className="bg-white p-6 shadow-md rounded-lg">
        ...
        <div className="flex items-center mt-4">
           ...
           <div className="ml-4 ">
                ...
                <p className="text-sm text-gray-500">4.76 (345 reviewa)</p>
                <p className="text-sm text-gray-500">
                    {bookingDetails.startDate} • {bookingDetails.totalNights}
                    Nights
                </p>
            </div> 
        </div>
        ...
        <div className="mt-6">
            ...
            <div className="flex justify-between mt-2 font-sembold">
                <p>Grand Total</p>
